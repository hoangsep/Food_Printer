...
#endif
// Start modifying, mix mode for food printer
// Explain the meaning for mixing ratio 1 to 3
FSTRINGVALUE(Com::tEPRExtruderRatio1, "Extruder mixing ratio 1 [percent]");
FSTRINGVALUE(Com::tEPRExtruderRatio2, "Extruder mixing ratio 2 [percent]");
FSTRINGVALUE(Com::tEPRExtruderRatio3, "Extruder mixing ratio 3 [percent]");
// End modifying, mix mode for food printer
